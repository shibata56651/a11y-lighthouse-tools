...
//     // Chromium の起動（固定ポート9222を明示的に指定）
//     chrome = await launch({
//       chromePath,
//       port: 9222, // ここで固定ポートを指定
...
//     // 必要なら少し待機して、Chromium が完全に起動するのを待つ
//     await new Promise(resolve => setTimeout(resolve, 3000));

//     // Lighthouse のオプションで固定ポート9222を使用
//     const options = {
//       logLevel: "info" as const,
//       output: "json" as const,
//       onlyCategories: ["performance", "seo", "pwa"],
//       port: 9222,  // 固定値
//     };
...
//     const runnerResult: RunnerResult = await lighthouse(parsedUrl.href, options, config);
